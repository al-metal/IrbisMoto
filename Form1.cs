        ...
        private string ReturnRazdel(string razdel)
        {
            switch (razdel)
            {
                ...
                case "снегоходы Dingo":
                    razdel = "Запчасти и расходники => Запчасти для снегоходов и мотобуксировщиков => Запчасти на снегоходы Dingo";
                    break;
                case "мотобуксировщики Мухтар":
                    razdel = "Запчасти и расходники => Запчасти для снегоходов и мотобуксировщиков => Запчасти на мотобуксировщики Мухтар";
                    break;
                case "Аккумуляторная":
